...
class PageViewModel {
  ...
  PageViewModel(
      ...
      this.bubbleBackgroundColor = const Color(0xFFA1AEB7),
      this.iconColor,
      @required this.title,
      @required this.body,
  ...
  TextStyle get titleTextStyle {
    return TextStyle(color: Colors.white, fontSize: 10.0).merge(this.textStyle);
  }

  TextStyle get bodyTextStyle {
    return TextStyle(color: Colors.white, fontSize: 14.0).merge(this.textStyle);
  }
}
